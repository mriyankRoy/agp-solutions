...
import FacilitiesMobileDrawer from "./FacilitiesMobileDrawer"; // Import the new drawer
...
const Header = () => {
  ...
  const [isFacilitiesDrawerOpen, setIsFacilitiesDrawerOpen] = useState(false); // New state
  ...
  const navItems = [
    ...
    { name: "Facilities", isDrawer: true }, // Changed path to isDrawer: true
          ...
          <div className="grid grid-cols-[1fr_auto_1fr] md:grid-cols-[auto_1fr_auto] h-18 md:h-20 items-center gap-4">
            ...
            <div className="flex items-center justify-end">
              <nav className="hidden md:flex items-center justify-end gap-x-2">
                ...
                <div className="pl-4 border-l border-white/10"><HeaderSearch /></div>
              </nav>
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (item.name === "Facilities") setIsFacilitiesDrawerOpen(true); // Toggle Facility Drawer
                    }}
