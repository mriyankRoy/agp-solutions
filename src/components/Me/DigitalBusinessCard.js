...
import { 
  ...
  MessageSquare, Cpu, ShieldCheck, QrCode, User 
} from 'lucide-react';
...
const DigitalBusinessCard = () => {
  ...
  // Ensure window is defined (Fixes production hydration issues)
  useEffect(() => {
  ...
  const data = {
    ...
    whatsapp: "5434323444",
    profileImage: "https://media.licdn.com/dms/image/v2/C4D03AQGWl3hr_5Hgwg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1631744890167?e=2147483647&v=beta&t=HjNo8kXRIppSz5qOydFE14gMT9ojtfQ_hm6Tmuy3W6c", // Replace with your actual production image URL
  };
  ...
  const handleSaveContact = () => {
    const vcard = [
      ...
      `URL:${data.website}`,
      "END:VCARD"
    ].join("\r\n"); // Standardized line endings for production
    ...
    // Cleanup to prevent memory leaks in production
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-[#1A1A1E] flex flex-col items-center justify-center p-4 font-sans selection:bg-[#BF092F] selection:text-white">
      ...
      {/* MAIN CONTAINER */}
      <div className="w-full max-w-md bg-[#44444E] rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-t-4 border-[#BF092F] overflow-hidden relative min-h-[600px] flex flex-col border border-white/5">
        ...
        {activeTab === 'card' ? (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col h-full relative z-10">
            ...
            <div className="p-8 pb-0 flex justify-between items-start">
               ...
               <span className="text-[9px] font-mono text-white/30 tracking-[0.3em] uppercase">{data.id}</span>
            </div>
          ...
          <div className="animate-in fade-in zoom-in-95 duration-500 flex flex-col items-center justify-center h-full p-12 relative z-10 text-center">
            <div className="p-6 bg-white rounded-[2.5rem] shadow-[0_0_60px_rgba(191,9,47,0.25)] mb-8">
              <QRCodeSVG 
                ...
                fgColor="#44444E"
                imageSettings={{
                    src: "https://www.artgpower.co.uk/favicon.ico", // Optional: your logo in the middle
                    height: 30,
                    width: 30,
                    excavate: true,
                }}
